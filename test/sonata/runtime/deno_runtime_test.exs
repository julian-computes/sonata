defmodule Sonata.Runtime.DenoRuntimeTest do
  ...
  describe "execute_file/2" do
    test "executes deno workflow successfully", %{tmp_dir: tmp_dir} do
      ...
      expect(Sonata.Utils.SystemMock, :cmd, fn "deno", args, opts ->
