defmodule SonataWeb.WorkflowExecutorControllerTest do
  ...
  setup do
    Process.put(:sonata_executor_workflowexecutor, Sonata.Executor.WorkflowExecutorMock)
    :ok
  end
  ...
  describe "execute/2" do
    test "successfully executes workflow", %{conn: conn} do
      ...
      expect(Sonata.Executor.WorkflowExecutorMock, :execute, fn @repo_url,
                                                                   @workflow_path,
                                                                   [] ->
