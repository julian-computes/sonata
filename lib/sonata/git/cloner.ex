defmodule Sonata.Git.Cloner do
  @moduledoc """
  ...
  defp impl do
    Process.get(:sonata_git_cloner, Sonata.Git.ClonerImpl)
  end
end

defmodule Sonata.Git.ClonerImpl do
  @behaviour Sonata.Git.Cloner
  ...
  defp run_git_command(args, operation, opts \\ []) do
    ...
    case Sonata.Utils.System.cmd("git", args, opts) do
      {_, 0} -> :ok
