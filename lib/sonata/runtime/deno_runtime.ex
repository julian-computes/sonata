defmodule Sonata.Runtime.DenoRuntime do
  @moduledoc """
  ...
  defp impl do
    Process.get(:sonata_runtime_denoruntime, Sonata.Runtime.DenoRuntimeImpl)
  end
end
...
defmodule Sonata.Runtime.DenoRuntimeImpl do
  ...
  defp run_deno_workflow(folder_path, main_file_path, temp_path, params) do
    try do
      ...
      case Sonata.Utils.System.cmd("deno", deno_args,
